...
"\nUsage: perl $0 [arguments]
   ...
   EXAMPLE
         perl $0 --gt_file=sample_data/sample_trees_file.tre --outgroup=Danio --output=njst_sample
...
-e $r_code or die ("\nERROR: $r_code does not exist. Provide correct path to the provided R code for running NJst with --r_code. \n\n$usage");
